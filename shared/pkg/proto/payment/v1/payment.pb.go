...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponseB\xc9\x01\n" +
	"\x0ecom.payment.v1B\fPaymentProtoP\x01Z`github.com/olezhek28/microservices-course-olezhek-solution/shared/pkg/proto/payment/v1;paymentv1\xa2\x02\x03PXX\xaa\x02\n" +
	"Payment.V1\xca\x02\n" +
